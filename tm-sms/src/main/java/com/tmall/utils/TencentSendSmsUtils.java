...
@Slf4j
@Component
@EnableConfigurationProperties(TencentSmsSendProperties.class)
public class TencentSendSmsUtils {
    @Autowired
    private TencentSmsSendProperties tssp;
    //产品域名,开发者无需替换
    static final String domain = "sms.tencentcloudapi.com";
    static final String SignMethod = "HmacSHA256";
     ...
     * @param templateParamSet 验证码
     * @return
     */
    public SendSmsResponse sendSms(String smsSdkAppid, String[] phoneNumber, String sign, String templateID, String[] templateParamSet) throws TencentCloudSDKException {
         ...
         * CAM密匙查询: https://console.cloud.tencent.com/cam/capi*/
            Credential cred = new Credential(tssp.getSecretId(), tssp.getSecretKey());
            ...
            httpProfile.setReqMethod(REQ_POST);
            ...
            if (!"OK".equals(sendSmsResponse.getRequestId())) {
                log.info("【短信服务】发送短信失败,phoneNumber:{ " + phoneNumber + "}", "原因:{" + sendSmsResponse.getRequestId() + "}");
            }
            log.info("【短信服务】,发送短信验证码，手机号:{" + phoneNumber + "}");
            //发送短信成功写入redis,指定生存时间为一分钟
